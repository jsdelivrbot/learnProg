...
define('ember-quickstart/tests/test-helper', ['ember-quickstart/app', '@ember/test-helpers', 'ember-qunit'], function (_app, _testHelpers, _emberQunit) {
  'use strict';
...
define('ember-quickstart/tests/unit/routes/demo-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
